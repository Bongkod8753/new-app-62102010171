...
NEWS_URL = "http://newsapi.org/v2/everything?q={0}&from=2021-2-02&sortBy=publishedAt&apiKey={1}"

NEWS_KEY = "2d6e3937a9654172a824f55e2e0c4d1e"
...
def CovidNews(): #ดึงข่าว
    url = "http://newsapi.org/v2/everything?q=covid&from=2021-2-02&sortBy=publishedAt&apiKey=2d6e3937a9654172a824f55e2e0c4d1e"
